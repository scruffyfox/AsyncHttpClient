...
```java
	...
	JsonElement response = client.put("api/v1/", headers, new JsonResponseHandler());
```
...
```java
	...
	JsonElement response = client.put("api/v1/", params, entity, headers, new JsonResponseHandler());
	});
```
